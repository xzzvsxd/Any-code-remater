...
pub(crate) fn compare_node_versions(a: &str, b: &str) -> std::cmp::Ordering {
...
#[cfg(target_os = "macos")]
pub(crate) fn get_npm_prefix() -> Option<String> {
...
pub(crate) fn test_claude_binary(path: &str) -> bool {
...
pub(crate) fn extract_version_from_output(stdout: &[u8]) -> Option<String> {
