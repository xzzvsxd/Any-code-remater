...
pub async fn get_gemini_usage_stats(
    ...
    tokio::task::spawn_blocking(move || get_gemini_usage_stats_blocking(start_date, end_date))
        .await
        .map_err(|e| format!("get_gemini_usage_stats task failed: {}", e))?
}

fn get_gemini_usage_stats_blocking(
    start_date: Option<String>,
    end_date: Option<String>,
) -> Result<GeminiUsageStats, String> {
